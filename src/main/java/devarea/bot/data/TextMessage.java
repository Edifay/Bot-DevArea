...
public class TextMessage {
    ...
    public static final EmbedCreateSpec helpEmbed = EmbedCreateSpec.builder()
            ...
            .addField("Communication :", "`//devhelp` -> mentionne les membres ayant pris le rôle Dev'Helper.\n`//ask` -> donne les informations pour bien poser une question.\n`//meetup` -> permet de créer un meetup autour d'un sujet.\n\nLes channels d'aides vocaux sont créés automatiquement par le bot lors de la connexion au channel vocal : \"Votre channel d'aide\".", false)
            .addField("XP:", "`//rank` -> donne l'xp et le rang de la personne (mentionnable).\n`//leaderboard` -> permet de voir le classement des membres du serveur en xp.\n`//askreward [mention de la personne que vous avez aidée]` -> Si vous ou plusieurs personnes avez aidé quelqu'un à résoudre son problème, vous pouvez lui demander une récompense (en xp) avec cette commande.\n`//givereward` -> Si une ou plusieurs personnes vous ont aidé à résoudre votre problème et que vous désirez lui donner une récompense (en xp), vous pouvez le faire avec cette commande. Les chiffres : pour 10xp donnés 50xp reçus, ici le nombre d'xp est défini et inchangeable.", false)
            ...
            .addField("Le site", "Le serveur Dev'Area possède aussi un site internet qui permet de gérer certaines fonctionalités du serveur.\n\n   -> https://devarea.fr/", false)
    ...
    public static final EmbedCreateSpec startCSharp = EmbedCreateSpec.builder()
            ...
            .addField("Les outils", "Visual studio est l'outil de développement C# par excellence, il supporte et sublime la stack de technologie Microsoft au possible. JetBrains Rider est aussi un excellent outil de développement et totalement à niveau de VS.\nVisual studio code est plus proche d'un éditeur de texte qu'un IDE tel que VS ou Rider mais il offre des options de développement digne d'un IDE et a le mérite d'être léger pour le développement.\n\nVS et VSCode => https://visualstudio.microsoft.com/fr/\nRider => https://www.jetbrains.com/fr-fr/rider/", false)
            .addField("Bonne Chance !", "Maintenant vous pouvez naviguer dans les tutos, cours, et vidéos pour apprendre le C#. Le serveur est là si vous rencontrez certains problèmes.", false)
            .author(Init.client.getSelf().block().getUsername(), null, Init.client.getSelf().block().getAvatarUrl())
    ...
    public static final EmbedCreateSpec startPython = EmbedCreateSpec.builder()
            ...
            .description("Python est un langage de programmation interprété, multi-paradigme et multiplateforme. Il favorise la programmation impérative structurée, fonctionnelle et orientée objet.")
            .color(ColorsUsed.same)
            .addField("Installer Python", "Pour pouvoir programmer en python il faut d'abord télécharger la VM,  un programme qui va interpréter le code et pouvoir le faire fonctionner sur la machine.\n\n Il est simple d'installation, il suffit d'aller sur leur site officiel (https://www.python.org/) et de suivre les indications du téléchargement.", false)
            .addField("Les bases", "Il y a différents moyens pour apprendre le python, de nombreux sites permettent l'apprentissage et la compréhension des notions liées au python.", false)
            .addField("Il y a de nombreux cours écrits, cela permet de lire et d'aller à votre rythme.", "OpenClassroom: https://openclassrooms.com/fr/courses/4262331-demarrez-votre-projet-avec-python\nDeveloppez: https://python.developpez.com/tutoriels/apprendre-programmation-python/les-bases/?page=le-langage-python\nZeste de Savoir: https://zestedesavoir.com/tutoriels/799/apprendre-a-programmer-avec-python-3/", false)
            .addField("Ou encore des cours vidéos...", "CodeAvecJonathan: https://www.youtube.com/watch?v=oUJolR5bX6g\nYvan Monka: https://www.youtube.com/watch?v=VmOPhT4HFNE", false)
            .addField("IDE (logiciels simplifiant le développement)", "Les IDE sont des logiciels très puissant, qui rassemblent tous les outils permettant le développement. Je vais vous en proposer 2, qui sont les plus connus dans le langage python.\n\nJetBrain PyCharm: https://www.jetbrains.com/fr-fr/pycharm/\nVisualStudioCode: https://code.visualstudio.com/\n\nChoisissez celui qui vous fait le plus envie :)", false)
            .addField("Bonne Chance !", "Maintenant vous pouvez naviguer dans les tutos, cours, et vidéos pour apprendre le python. Le serveur est là si vous rencontrez certains problèmes.", false)
            .author(Init.client.getSelf().block().getUsername(), null, Init.client.getSelf().block().getAvatarUrl())
            .timestamp(Instant.now()).build();

    public static final EmbedCreateSpec startHtmlCss = EmbedCreateSpec.builder()
            .title("HTML / CSS")
            .description("Le HTML (HyperText Markup Language), est un langage de balisage conçu pour réaliser des pages web. HTML est une des trois inventions à la base du World Wide Web, avec le HyperText Transfer Protocol et les adresses web. HTML a été inventé pour permettre d'écrire des documents hypertextuels liant les différentes ressources d’Internet avec des hyperliens.")
            .color(ColorsUsed.same)
            ...
            .addField("Les cours écrits", "OpenClassroom : https://openclassrooms.com/fr/courses/1603881-apprenez-a-creer-votre-site-web-avec-html5-et-css3\nDeveloppez : https://www.developpez.com/actu/177723/Apprendre-la-programmation-Web-moins-HTML-CSS-a-travers-des-TD-un-tutoriel-de-Romain-Lebreton/\nZeste de savoir : https://zestedesavoir.com/tutoriels/599/creer-un-jeu-html5-avec-quintus/272_decouverte-de-la-librairie/1554_creer-une-page-html-basique/", false)
            .addField("Les cours vidéos", "Les Teachers Du Net: https://www.youtube.com/watch?v=YT7eJufmOQM\nEt plein d'autres je vous laisse chercher si cette chaîne ne vous convient pas :/", false)
            .addField("IDE (logiciels simplifiant le développement)", "Les IDE sont des logiciels très puissant, qui rassemblent tous les outils permettant le développement.\n\nVisual Studio Code : https://code.visualstudio.com/\nWebStorm : https://www.jetbrains.com/fr-fr/webstorm/\nSublime Text : http://www.sublimetext.com/\nAtom : https://atom.io/\nChoisissez celui qui vous fait le plus envie :)", false)
            .addField("Bonne Chance !", "Maintenant vous pouvez naviguer dans les tutos, cours, et vidéos pour apprendre l'HTML/CSS. Le serveur est là si vous rencontrez certains problèmes.", false)
            .author(Init.client.getSelf().block().getUsername(), null, Init.client.getSelf().block().getAvatarUrl())
            .timestamp(Instant.now()).build();
    ...
    public static final EmbedCreateSpec startCommandExplain = EmbedCreateSpec.builder()
            .title("Start")
            .description("Cette commande permet aux débutants d'avoir les liens, et les premières indications sur un langage.")
    ...
    public static final EmbedCreateSpec meetupCreateGetDate = EmbedCreateSpec.builder()
            .title("Date")
            .description("Quand voulez-vous organiser ce meetup. Donnez la date et l'heure sous la forme **dd/MM/yyyy hh:mm**. Par exemple `" + Calendar.getInstance().get(Calendar.DAY_OF_MONTH) + "/" + (Calendar.getInstance().get(Calendar.MONTH) + 1) + "/" + Calendar.getInstance().get(Calendar.YEAR) + " " + Calendar.getInstance().get(Calendar.HOUR) + ":" + Calendar.getInstance().get(Calendar.MINUTE) + "`.")
    ...
    public static final EmbedCreateSpec meetupCreateAsk = EmbedCreateSpec.builder()
            ...
            .description("Le staff va analyser votre demande, vous recevrez un message pour vous tenir au courant de son avancement !")
            .color(ColorsUsed.just)
            .timestamp(Instant.now()).build();
    ...
    public static final EmbedCreateSpec missionSupport = EmbedCreateSpec.builder()
            .title("Creation d'une mission")
            .description("Donnez le support sur lequel vous voulez que votre programme fonctionne. Web, linux, windows, discord.js....")
            .footer("cancel | annuler pour quitter.", null)
            .color(ColorsUsed.just).build();

    public static final EmbedCreateSpec missionLangage = EmbedCreateSpec.builder()
            .title("Creation d'une mission")
            .description("Donnez le langage de programmation que vous voulez (si vous n'en avez pas vous pouvez marquer `aucune préférence`).")
            .footer("cancel | annuler pour quitter.", null)
            .color(ColorsUsed.just).build();

    public static final EmbedCreateSpec missionPrix = EmbedCreateSpec.builder()
            .title("Creation d'une mission")
            .description("Donnez le prix/budget que vous pouvez mettre dans cette mission ! (Pensez à mettre la devise)")
            .footer("cancel | annuler pour quitter.", null)
            .color(ColorsUsed.just).build();
