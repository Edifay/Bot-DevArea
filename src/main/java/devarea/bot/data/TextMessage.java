...
public class TextMessage {
    ...
    public static final EmbedCreateSpec startJava = EmbedCreateSpec.builder()
            ...
            .addField("IDE (logiciels simplifiant le développement)", "Les IDE sont des logiciels très puissant, qui rassemblent tout les outils permettant le développement. Je vais vous en proposer 2, qui sont les plus connu dans le langage java.\n\nJetBrain IntelliJ: https://www.jetbrains.com/fr-fr/idea/download/#section=windows\nEclipse: https://www.eclipse.org/downloads/\n\nChoisissez celui qui vous fait le plus envie :)", false)
            .addField("Bonne Chance !", "Maintenant vous pouvez naviger dans les tutos, cours, et vidéos pour apprendre le java. Le serveur est là si vous rencontrez certains problèmes.", false)
    ...
    public static final EmbedCreateSpec startCSharp = EmbedCreateSpec.builder()
            ...
            .addField("Les outils", "Visual studio est l'outils de développement C# par excellence, il supporte et sublime la stack de technologie Microsoft au possible. JetBrains Rider est aussi un excellent outil de développement et totalement à niveau de VS.\nVisual studio code est plus proche d'un éditeur de texte qu'un IDE tel que VS ou Rider mais il offre des options de développement digne d'un IDE et a le mérite d'être léger pour le développement.\n\nVS et VSCode => https://visualstudio.microsoft.com/fr/\nRider => https://www.jetbrains.com/fr-fr/rider/", false)
            .addField("Bonne Chance !", "Maintenant vous pouvez naviger dans les tutos, cours, et vidéos pour apprendre le C#. Le serveur est là si vous rencontrez certains problèmes.", false)
            .author(Init.client.getSelf().block().getUsername(), null, Init.client.getSelf().block().getAvatarUrl())
    ...
    public static final EmbedCreateSpec startPython = EmbedCreateSpec.builder()
            ...
            .addField("Les bases", "Ils y a différents moyen pour apprendre le python, de nombreux sites permettent l'apprentissage et la compréhension des notions lié au python.", false)
            .addField("Il y a de nombreux cour écrits, cela permet de lire et d'aller à votre rythme.", "OpenClassroom: https://openclassrooms.com/fr/courses/4262331-demarrez-votre-projet-avec-python\nDeveloppez: https://python.developpez.com/tutoriels/apprendre-programmation-python/les-bases/?page=le-langage-python\nZeste de Savoir: https://zestedesavoir.com/tutoriels/799/apprendre-a-programmer-avec-python-3/", false)
            ...
            .addField("IDE (logiciels simplifiant le développement)", "Les IDE sont des logiciels très puissant, qui rassemblent tout les outils permettant le développement. Je vais vous en proposer 2, qui sont les plus connu dans le langage python.\n\nJetBrain PyCharm: https://www.jetbrains.com/fr-fr/pycharm/\nVisualStudioCode: https://code.visualstudio.com/\n\nChoisissez celui qui vous fait le plus envie :)", false)
            .addField("Bonne Chance !", "Maintenant vous pouvez naviger dans les tutos, cours, et vidéos pour apprendre le python. Le serveur est là si vous rencontrez certains problèmes.", false)
            .author(Init.client.getSelf().block().getUsername(), null, Init.client.getSelf().block().getAvatarUrl())
            .timestamp(Instant.now()).build();
    ...
    public static final EmbedCreateSpec startHtmlCss = EmbedCreateSpec.builder()
            ...
            .addField("Les bases", "On apprends l'HTML et le CSS pour faire des sites web.\nCe langage est très connu pour le dev web.", false)
            ...
            .addField("IDE (logiciels simplifiant le développement)", "Les IDE sont des logiciels très puissant, qui rassemblent tout les outils permettant le développement.\n\nVisual Studio Code : https://code.visualstudio.com/\nWebStorm : https://www.jetbrains.com/fr-fr/webstorm/\nSublime Text : http://www.sublimetext.com/\nAtom : https://atom.io/\nChoisissez celui qui vous fait le plus envie :)", false)
    ...
    public static EmbedCreateSpec meetupCommandExplain = EmbedCreateSpec.builder()
            .author("Les meetups sont des rencontres vocales/écrits sur un sujet créé par la communauté.", null, null)
            .title("Commandes")
    ...
    public static final EmbedCreateSpec missionDescription = EmbedCreateSpec.builder()
            .title("Creation d'une mission")
            .description("Donnez une description complète de votre mission, les aspect difficiles, et le contexte.")
            .footer("cancel | annuler pour quitter.", null)
            .color(ColorsUsed.just).build();

    public static final EmbedCreateSpec missionSupport = EmbedCreateSpec.builder()
            .title("Creation d'une mission")
            .description("Donnez le support sur le quel vous voulez que votre programme fonctionne. Web, linux, windows, discord.js....")
            .footer("cancel | annuler pour quitter.", null)
            .color(ColorsUsed.just).build();
    ...
    public static final EmbedCreateSpec missionPrix = EmbedCreateSpec.builder()
            .title("Creation d'une mission")
            .description("Donnez le prix/bugdet que vous pouvez mettre dans cette mission ! (Pensez à mettre la devise)")
            .footer("cancel | annuler pour quitter.", null)
            .color(ColorsUsed.just).build();
    ...
    public static final EmbedCreateSpec missionNiveau = EmbedCreateSpec.builder()
            .title("Creation d'une mission")
            .description("Donnez le niveau du difficulté de la mission (estimation).")
            .footer("cancel | annuler pour quitter.", null)
            .color(ColorsUsed.just).build();
}
