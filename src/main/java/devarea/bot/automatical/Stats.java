...
public class Stats {
    ...
    public static void init() throws IOException {
        ...
        try {
            ...
            channelMemberCount = (VoiceChannel) Init.devarea.getChannelById(Snowflake.of(document.getElementsByTagName("member").item(0).getChildNodes().item(0).getNodeValue())).block();
