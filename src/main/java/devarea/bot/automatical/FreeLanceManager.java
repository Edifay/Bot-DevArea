...
public class FreeLanceManager {
    ...
    private static void sendLastMessage() {
        messsage = Command.sendEmbed((TextChannel) Init.devarea.getChannelById(Init.idFreeLance).block(), embedCreateSpec -> {
    ...
    public static boolean verif() {
        ...
        for (FreeLance freeLance : freeLances) {
            ...
            try {
                Init.devarea.getMemberById(Snowflake.of(freeLance.getMemberId())).block();
                isMemberAlways = true;
